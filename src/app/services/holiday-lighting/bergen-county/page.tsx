...
const schema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id':
      'https://jonespressurewashing.com/services/holiday-lighting/bergen-county'
  },
  potentialAction: {
    '@type': 'ReserveAction',
    target: {
      ...
      <main className="bg-black text-white">
        ...
        <section className="bg-[#0b0b0f]">
          <div className="max-w-custom mx-auto px-6 py-16 space-y-8">
            <header className="space-y-4">
              ...
              <p>
                Bergen County bursts with neighborhood pride, from Ridgewood's
                bustling village calendar to Tenafly's estate lined avenues and
                Fort Lee's skyline views. Our holiday lighting Bergen County
                service adapts to every style. We map your architecture, note
                landscaping, and design displays that feel personal, whether you
                want warm white classics for historic colonials, jewel tones for
                modern builds, or color changing LEDs ready for Hanukkah,
                Christmas, and New Year Eve with the tap of a timer.
              </p>
              <p>
                With licensed, insured installers stationed across the county,
                you get fast communication, punctual crews, and detailed follow
                up. We carry OSHA compliant safety gear for steep roofs in Upper
                Saddle River, use slate safe clips for Glen Rock Tudors, and
                protect custom gutters in Mahwah. Every strand is labeled and
                photographed so next year's setup is even faster. The result is
                a Pinterest ready display without weekend ladder marathons or
                big box light failures.
              </p>
              <p>
                ...
                Bergen County tell us the best part is walking outside in
                November to a magazine worthy glow they did not have to install
                themselves.
              </p>
            </header>
        ...
        <section className="bg-black">
          <div className="max-w-custom mx-auto px-6 py-16 space-y-6">
            <h2>Cities We Transform Every Season</h2>
            <p>
              ...
              service trucks cover every zip code from the Palisades to the
              Ramapo Valley.
            </p>
        ...
        <section className="bg-[#0b0b0f]">
          <div className="max-w-custom mx-auto px-6 py-16 space-y-8">
            <header className="space-y-4">
              <h2>Design Styles That Stand Out in Bergen County</h2>
              <p>
                Every display is custom, but homeowners tend to gravitate toward
                three core design blueprints depending on architecture, lot
                size, and how many holiday events they host. Here is how we make
                the most of regional features and keep the look classy, not
                cluttered.
              </p>
            </header>
        ...
        <section className="bg-black">
          <div className="max-w-custom mx-auto px-6 py-16 space-y-8">
            <header className="space-y-4">
              <h2>Recent Bergen County Holiday Lighting Spotlights</h2>
              <p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <article className="rounded-lg border border-white/10 bg-white/5 p-6 space-y-3">
                ...
                <p>
                  A family hosting back to back December parties wanted a
                  cohesive look that was visible from both the street and the
                  backyard firepit. We installed warm white C9 rooflines with
                  dormer accents, wrapped four towering spruces using spiral LED
                  patterns, and added flicker resistant candle bulbs to every
                  window. Stake lighting guided guests down the long driveway,
                  and smart timers ensured the entire display powered down
                  before midnight to satisfy HOA quiet hours.
                </p>
              </article>
              <article className="rounded-lg border border-white/10 bg-white/5 p-6 space-y-3">
                <h3 className="text-primary">
                ...
                <p>
                  This project combined color changing LEDs on a steep slate
                  roof with programmable RGB tree wraps. The homeowner wanted
                  Hanukkah blues, Christmas reds and greens, and New Year golds
                  without reinstallation. We programmed the entire layout on a
                  Wi-Fi timer, provided remote access instructions, and
                  scheduled proactive maintenance visits following early
                  December storms. The result was a showstopping display that
                  shifted palettes for every gathering.
                </p>
              </article>
            </div>
          </div>
        ...
        <section className="bg-[#0b0b0f]">
          <div className="max-w-custom mx-auto px-6 py-16 space-y-8">
            <header className="space-y-4">
              <h2>Holiday Lighting Timeline for Bergen County Clients</h2>
              <p>
                The fastest way to secure your dream display is to work the
                process in stages. We maintain a detailed seasonal calendar so
                Franklin Lakes estate owners, Ridgewood shopkeepers, and Ho-Ho
                Kus families always know what comes next.
              </p>
            </header>
            <div className="space-y-6">
              {timeline.map(step => (
        ...
        <section className="bg-black">
          <div className="max-w-custom mx-auto px-6 py-16 space-y-8">
            <header className="space-y-4">
              <h2>Bergen County Holiday Lighting Checklist</h2>
              <p>
            ...
            <ul className="grid gap-4 md:grid-cols-2">
              ...
              <li className="rounded-lg border border-white/10 bg-white/5 p-4">
                Trim low branches and shrubs that could block ladders from
                safely reaching roof peaks, dormers, or tall evergreens.
              </li>
              <li className="rounded-lg border border-white/10 bg-white/5 p-4">
              ...
              <li className="rounded-lg border border-white/10 bg-white/5 p-4">
                Schedule a quick dusk walk through to confirm focal points,
                timer settings, and photo angles before we break down ladders.
              </li>
              <li className="rounded-lg border border-white/10 bg-white/5 p-4">
                Keep pets and children indoors during ladder work and let us
                know if there are locked gates or alarms that need temporary
                codes.
              </li>
            </ul>
          </div>
        ...
        <section className="bg-black">
          <div className="max-w-custom mx-auto px-6 py-16 space-y-8">
            <header className="space-y-4">
              <h2>Frequently Asked Questions from Bergen County Homeowners</h2>
              <p>
                We talk holiday lighting daily with homeowners, property
                managers, and storefront owners across Bergen County. These are
                the top questions we answer before, during, and after every
                project.
              </p>
            </header>
            <div className="space-y-6">
        ...
        <section className="bg-[#0b0b0f]">
          <div className="max-w-custom mx-auto px-6 py-16 space-y-6">
            ...
            <p>
              ...
              holiday lighting Bergen County experience. Start with a quick
              design consultation, share inspiration photos, HOA guidelines, or
              a Pinterest board, and we will translate it into a fully managed
